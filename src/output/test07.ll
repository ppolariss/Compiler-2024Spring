...
bb13:                                             ; preds = %bb11
  %r118 = load i32, i32* %r112, align 4
  call void @putint(i32 %r118)
  call void @_sysy_stoptime(i32 10)
  ret i32 0

0:                                                ; No predecessors!
  store i32 1, i32* %r119, align 4
  %r120 = load i32, i32* %r119, align 4
  ret i32 %r120
...
2:                                                ; No predecessors!
  store i32 3, i32* %r123, align 4
  %r124 = load i32, i32* %r123, align 4
  ret i32 %r124

3:                                                ; No predecessors!
  store i32 4, i32* %r125, align 4
  %r126 = load i32, i32* %r125, align 4
  ret i32 %r126

4:                                                ; No predecessors!
  store i32 5, i32* %r127, align 4
  ret i32 0
}
