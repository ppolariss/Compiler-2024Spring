...
split:
  ...
  %r116 = load i32, i32* @N, align 4
  %r115 = sub i32 %r116, 1
  store i32 %r115, i32* %r114, align 4
  br label %bb1
...
bb2:                                              ; preds = %bb1
  ...
  %r125 = load i32, i32* %r112, align 4
  %r124 = sdiv i32 %r125, 10
  store i32 %r124, i32* %r112, align 4
  %r127 = load i32, i32* %r114, align 4
  %r126 = sub i32 %r127, 1
