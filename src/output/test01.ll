...
bb2:                                              ; preds = %bb1
  ...
  store i32 %r106, i32* %r104, align 4
  %r108 = load i32, i32* %r100, align 4
  %r107 = add i32 %r108, 1
  store i32 %r107, i32* %r100, align 4
  br label %bb1
...
bb5:                                              ; preds = %bb4
  ...
  %r114 = load i32, i32* %r101, align 4
  %r115 = load i32, i32* %r111, align 4
  %r113 = add i32 %r114, %r115
  store i32 %r113, i32* %r101, align 4
...
bb6:                                              ; preds = %bb4
  ...
  %r119 = load i32, i32* @c, align 4
  call void @putint(i32 %r119)
  %r120 = load i32, i32* %r101, align 4
