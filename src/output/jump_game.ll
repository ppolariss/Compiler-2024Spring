...
bb3:                                              ; preds = %bb2, %0
  ...
  %r107 = load i32, i32* %r106, align 4
...
bb8:                                              ; preds = %bb7
  %r117 = load i32, i32* %r111, align 4
  %r116 = getelementptr [10 x i32], [10 x i32]* %r110, i32 0, i32 %r117
  store i32 0, i32* %r116, align 4
  %r119 = load i32, i32* %r111, align 4
  %r118 = add i32 %r119, 1
  store i32 %r118, i32* %r111, align 4
  br label %bb7

bb9:                                              ; preds = %bb7
  %r121 = load i32, i32* %r102, align 4
  %r120 = sub i32 %r121, 1
  store i32 %r120, i32* %r122, align 4
  ...
  %r125 = sub i32 %r126, 2
  store i32 %r125, i32* %r111, align 4
  br label %bb10

bb10:                                             ; preds = %bb18, %bb9
  %r128 = load i32, i32* %r111, align 4
  %r129 = sub i32 0, 1
  %r127 = icmp sgt i32 %r128, %r129
  br i1 %r127, label %bb11, label %bb12

bb11:                                             ; preds = %bb10
  %r133 = load i32, i32* %r111, align 4
  %r132 = getelementptr i32, i32* %r100, i32 %r133
  %r134 = load i32, i32* %r132, align 4
  %r136 = load i32, i32* %r102, align 4
  %r135 = sub i32 %r136, 1
...
bb13:                                             ; preds = %bb11
  ...
  store i32 %r141, i32* %r130, align 4
  br label %bb15

bb14:                                             ; preds = %bb11
  %r143 = load i32, i32* %r102, align 4
  %r142 = sub i32 %r143, 1
  %r145 = load i32, i32* %r111, align 4
  %r144 = sub i32 %r142, %r145
  store i32 %r144, i32* %r130, align 4
  br label %bb15
...
bb16:                                             ; preds = %bb21, %bb15
  %r147 = load i32, i32* %r130, align 4
  %r148 = sub i32 0, 1
...
bb21:                                             ; preds = %bb20, %bb19
  %r159 = load i32, i32* %r130, align 4
  %r158 = sub i32 %r159, 1
  store i32 %r158, i32* %r130, align 4
  br label %bb16

bb18:                                             ; preds = %bb16
  %r161 = load i32, i32* %r111, align 4
  %r160 = sub i32 %r161, 1
  store i32 %r160, i32* %r111, align 4
  br label %bb10

bb12:                                             ; preds = %bb10
  %r162 = getelementptr [10 x i32], [10 x i32]* %r110, i32 0, i32 0
  %r163 = load i32, i32* %r162, align 4
  ret i32 %r163
