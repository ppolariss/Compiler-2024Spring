...
bb4:                                              ; preds = %bb16, %bb3
  %r127 = load i32, i32* %r100, align 4
  %r126 = icmp slt i32 %r127, 10
  br i1 %r126, label %bb7, label %bb8

bb7:                                              ; preds = %bb4
  store i32 1, i32* %r125, align 4
  br label %bb9

bb8:                                              ; preds = %bb4
  store i32 0, i32* %r125, align 4
  br label %bb9
...
bb11:                                             ; preds = %bb10
  store i32 1, i32* %r130, align 4
  br label %bb13

bb12:                                             ; preds = %bb10
  store i32 0, i32* %r130, align 4
  br label %bb13
...
bb5:                                              ; preds = %bb13
  %r137 = load i32, i32* %r100, align 4
  %r136 = getelementptr [10 x i32], [10 x i32]* %r102, i32 0, i32 %r137
  %r138 = load i32, i32* %r136, align 4
  %r139 = load i32, i32* %r111, align 4
  %r135 = icmp eq i32 %r138, %r139
  br i1 %r135, label %bb14, label %bb15

bb14:                                             ; preds = %bb5
  store i32 1, i32* %r123, align 4
  %r140 = load i32, i32* %r100, align 4
  store i32 %r140, i32* %r124, align 4
  br label %bb16
...
bb16:                                             ; preds = %bb15, %bb14
  %r142 = load i32, i32* %r100, align 4
  %r141 = add i32 %r142, 1
  store i32 %r141, i32* %r100, align 4
  br label %bb4

bb6:                                              ; preds = %bb13, %bb9
  %r144 = load i32, i32* %r123, align 4
...
bb18:                                             ; preds = %bb6
  ...
  %r146 = load i32, i32* %r111, align 4
