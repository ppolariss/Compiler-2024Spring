...
bar:
  ...
  store i32 %r130, i32* %r131, align 4
  %r135 = load i32, i32* %r131, align 4
  call void @putint(i32 %r135)
  %r136 = getelementptr i32, i32* %r132, i32 1
  store i32 4, i32* %r136, align 4
  %r137 = alloca i32, align 4
  %r138 = icmp sgt i32 1, 2
  br i1 %r138, label %bb4, label %bb5

bb4:                                              ; preds = %bar
  store i32 1, i32* %r137, align 4
  br label %bb6

bb5:                                              ; preds = %bar
  store i32 0, i32* %r137, align 4
  br label %bb6
...
bb10:                                             ; preds = %bb9, %bb8
  %r145 = load i32, i32* %r141, align 4
...
bb3:                                              ; preds = %bb2, %0
  store i32 0, i32* %r147, align 4
  br label %bb11

bb11:                                             ; preds = %bb23, %bb22, %bb3
  %r150 = load i32, i32* %r147, align 4
...
bb22:                                             ; preds = %bb12
  %r174 = load i32, i32* %r147, align 4
  %r173 = add i32 %r174, 1
  store i32 %r173, i32* %r147, align 4
  br label %bb11
...
bb13:                                             ; preds = %bb21, %bb20, %bb16
  ...
  %r189 = load i32, i32* %r184, align 4
  %r190 = load i32, i32* %r187, align 4
  %r188 = add i32 %r189, %r190
  store i32 %r188, i32* %r181, align 4
  ret void
}
