...
add:
  ...
  %r107 = load i32, i32* %r104, align 4
  %r108 = load i32, i32* %r105, align 4
  %r106 = add i32 %r107, %r108
  store i32 %r106, i32* %r103, align 4
  %r109 = getelementptr %arrary, %arrary* %r102, i32 0, i32 0
  %r111 = load i32, i32* %r109, align 4
  %r110 = add i32 %r111, 1
  ret i32 %r110
...
define i32 @main() {
main:
  %r112 = alloca %arrary, align 8
  %r113 = alloca %arrary, align 8
  %r114 = getelementptr %arrary, %arrary* %r112, i32 0, i32 0
  store i32 1, i32* %r114, align 4
  %r115 = getelementptr %arrary, %arrary* %r113, i32 0, i32 0
  store i32 2, i32* %r115, align 4
