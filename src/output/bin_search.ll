...
bb2:                                              ; preds = %bb1
  ...
  %r110 = load i32, i32* %r100, align 4
  %r109 = add i32 %r110, 1
  store i32 %r109, i32* %r100, align 4
  br label %bb1
...
bb3:                                              ; preds = %bb1
  ...
  %r117 = sub i32 %r118, 1
  store i32 %r117, i32* %r112, align 4
...
bb4:                                              ; preds = %bb16, %bb3
  ...
  %r127 = load i32, i32* %r125, align 4
...
bb9:                                              ; preds = %bb8, %bb7
  %r129 = load i32, i32* %r123, align 4
  %r130 = icmp ne i32 %r129, 0
  br i1 %r130, label %bb10, label %bb6

bb10:                                             ; preds = %bb9
  %r133 = load i32, i32* %r113, align 4
  %r134 = load i32, i32* %r112, align 4
  %r132 = icmp slt i32 %r133, %r134
  br i1 %r132, label %bb11, label %bb12

bb11:                                             ; preds = %bb10
  store i32 1, i32* %r131, align 4
  br label %bb13

bb12:                                             ; preds = %bb10
  store i32 0, i32* %r131, align 4
  br label %bb13
...
bb5:                                              ; preds = %bb13
  %r138 = load i32, i32* %r112, align 4
  %r139 = load i32, i32* %r113, align 4
  %r137 = add i32 %r138, %r139
  %r140 = sdiv i32 %r137, 2
  store i32 %r140, i32* %r114, align 4
  %r142 = load i32, i32* %r111, align 4
  %r144 = load i32, i32* %r114, align 4
...
bb14:                                             ; preds = %bb5
  %r147 = load i32, i32* %r114, align 4
  %r146 = sub i32 %r147, 1
  store i32 %r146, i32* %r112, align 4
  br label %bb16

bb15:                                             ; preds = %bb5
  %r149 = load i32, i32* %r114, align 4
  %r148 = add i32 %r149, 1
  store i32 %r148, i32* %r113, align 4
  br label %bb16
