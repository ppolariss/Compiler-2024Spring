...
bb2:                                              ; preds = %bb1
  %r103 = call i32 @getch()
  %r105 = load i32, i32* @ascii_0, align 4
  %r104 = sub i32 %r103, %r105
  store i32 %r104, i32* %r101, align 4
  %r108 = load i32, i32* %r101, align 4
  %r107 = icmp slt i32 %r108, 0
  br i1 %r107, label %bb7, label %bb8

bb7:                                              ; preds = %bb2
  store i32 1, i32* %r106, align 4
  br label %bb9

bb8:                                              ; preds = %bb2
  store i32 0, i32* %r106, align 4
  br label %bb9

bb9:                                              ; preds = %bb8, %bb7
  %r109 = load i32, i32* %r106, align 4
...
bb13:                                             ; preds = %bb12, %bb11
  %r114 = load i32, i32* %r111, align 4
...
bb3:                                              ; preds = %bb5, %bb1
  %r116 = load i32, i32* %r101, align 4
  store i32 %r116, i32* %r100, align 4
  br label %bb14
...
bb15:                                             ; preds = %bb14
  %r118 = call i32 @getch()
  %r120 = load i32, i32* @ascii_0, align 4
  %r119 = sub i32 %r118, %r120
  store i32 %r119, i32* %r101, align 4
  %r123 = load i32, i32* %r101, align 4
  %r122 = icmp sge i32 %r123, 0
  br i1 %r122, label %bb20, label %bb21

bb20:                                             ; preds = %bb15
  store i32 1, i32* %r121, align 4
  br label %bb22

bb21:                                             ; preds = %bb15
  store i32 0, i32* %r121, align 4
  br label %bb22

bb22:                                             ; preds = %bb21, %bb20
  %r124 = load i32, i32* %r121, align 4
  %r125 = icmp ne i32 %r124, 0
  br i1 %r125, label %bb23, label %bb18

bb23:                                             ; preds = %bb22
  %r128 = load i32, i32* %r101, align 4
  %r127 = icmp sle i32 %r128, 9
  br i1 %r127, label %bb24, label %bb25

bb24:                                             ; preds = %bb23
  store i32 1, i32* %r126, align 4
  br label %bb26

bb25:                                             ; preds = %bb23
  store i32 0, i32* %r126, align 4
  br label %bb26

bb26:                                             ; preds = %bb25, %bb24
  %r129 = load i32, i32* %r126, align 4
  %r130 = icmp ne i32 %r129, 0
  br i1 %r130, label %bb17, label %bb18

bb17:                                             ; preds = %bb26
  %r132 = load i32, i32* %r100, align 4
  %r131 = mul i32 %r132, 10
  %r134 = load i32, i32* %r101, align 4
  %r133 = add i32 %r131, %r134
  store i32 %r133, i32* %r100, align 4
  br label %bb19

bb18:                                             ; preds = %bb26, %bb22
  br label %bb16
...
mod:
  ...
  store i32 %r136, i32* %r137, align 4
  %r139 = alloca i32, align 4
  store i32 %r138, i32* %r139, align 4
  %r141 = load i32, i32* %r137, align 4
  %r142 = load i32, i32* %r139, align 4
  %r140 = sdiv i32 %r141, %r142
  %r144 = load i32, i32* %r139, align 4
  %r143 = mul i32 %r140, %r144
  %r146 = load i32, i32* %r137, align 4
...
my_putint:
  ...
  store i32 %r147, i32* %r148, align 4
  %r149 = alloca [16 x i32], align 4
  %r150 = alloca i32, align 4
  store i32 0, i32* %r150, align 4
  br label %bb27

bb27:                                             ; preds = %bb28, %my_putint
  %r152 = load i32, i32* %r148, align 4
...
bb28:                                             ; preds = %bb27
  ...
  %r156 = load i32, i32* %r148, align 4
  %r155 = call i32 @mod(i32 %r156, i32 10)
  %r158 = load i32, i32* @ascii_0, align 4
  %r157 = add i32 %r155, %r158
  store i32 %r157, i32* %r153, align 4
  %r160 = load i32, i32* %r148, align 4
  %r159 = sdiv i32 %r160, 10
  store i32 %r159, i32* %r148, align 4
  %r162 = load i32, i32* %r150, align 4
  %r161 = add i32 %r162, 1
  store i32 %r161, i32* %r150, align 4
  br label %bb27
...
bb31:                                             ; preds = %bb30
  %r166 = load i32, i32* %r150, align 4
  %r165 = sub i32 %r166, 1
  store i32 %r165, i32* %r150, align 4
  %r168 = load i32, i32* %r150, align 4
  %r167 = getelementptr [16 x i32], [16 x i32]* %r149, i32 0, i32 %r168
  %r169 = load i32, i32* %r167, align 4
...
main:
  ...
  store i32 %r170, i32* %r171, align 4
  br label %bb33

bb33:                                             ; preds = %bb34, %main
  %r173 = load i32, i32* %r171, align 4
...
bb34:                                             ; preds = %bb33
  ...
  %r178 = load i32, i32* %r171, align 4
  %r177 = sub i32 %r178, 1
  store i32 %r177, i32* %r171, align 4
  br label %bb33
